...
| [`notes.md`](../spec/notes.md) | Registro de decisões — uma entrada por decisão fechada, cada uma com a alternativa rejeitada e o que a reabriria (em inglês) |
...
- Uma especificação escrita (`instructions.md`), um registro de decisões append-only (`notes.md`) e cenários de aceitação em Gherkin (`bdd.md`).

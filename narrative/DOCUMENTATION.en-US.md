...
| [`notes.md`](../spec/notes.md) | Decision record — 47 entries, each with the rejected alternative and what would reopen it |
...
- A written specification (`instructions.md`), a 47-entry decision record (`notes.md`), and Gherkin acceptance scenarios (`bdd.md`).
